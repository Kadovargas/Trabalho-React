        ...
        <TableBody>
          {livros.map(livro => (
            <StyledTableRow  key={livro.id}>
              ...
              <StyledTableCell  align="right">{livro.id}</StyledTableCell >
              <StyledTableCell  align="right">{livro.issbn}</StyledTableCell >
              <StyledTableCell  align="right">{livro.quantidade}</StyledTableCell >
              <StyledTableCell  align="center">
                  <button type="button" onClick={() => handleDeleteLivro(livro.id)}>Excluir</button></StyledTableCell >
            </StyledTableRow >
          ))}
        </TableBody>
      </Table>
